    ...
    : FramedWidget(QColor(0,255,255), parent)
{
    ...
    this->setStyleSheet(R"(
        ...
        QPushButton {
            ...
            border-radius: 30px; /* Make them round */
        }
        QPushButton:pressed {
            background-color: #00FFFF; /* Cyan press */
            color: black;
        }
        ...
        QProgressBar {
            border: 1px solid #555;
            border-radius: 5px;
            background-color: #222; /* Trough background */
            height: 40px;
        }
        QProgressBar::chunk {
            background-color: #00FFFF; /* Cyan 'lit' bars */
        ...
        #hvacButtonContainer QPushButton:checked {
            background-color: #00FFFF; /* ON state: 'fill' */
